  ...
  (function(jQuery) {
    return jQuery.widget("IKS.halloimage", {
      options: {
        ...
        toolbar: null,
        uuid: "",
        searchUrl: "app_dev.php/liip/vie/assets/search",
        dialogOpts: {
          autoOpen: false,
          width: 270,
          height: 500,
          ...
          close: function(ev, ui) {
            return jQuery('.image_button').removeClass('ui-state-active');
          }
        },
        dialog: null
      },
      _create: function() {
          ...
          jQuery.ajax({
            ...
            success: function(response) {
              ...
              $.each(response.assets, function(key, val) {
                return items.push("<img src=\"" + val.url + "\" class=\"search_result_image " + widget.widgetName + "-imageThumbnail\" />");
              });
              jQuery(that).parents().contents().find('.searchResults').html(items.join(''));
              return jQuery("." + widget.widgetName + "-imageThumbnail").live("click", function(event) {
                ...
                return jQuery("#" + widget.options.uuid + "-" + widget.widgetName + "-activeImage_search").attr("src", jQuery(this).attr("src"));
              });
            }
          });
        ...
        jQuery("." + widget.widgetName + "-imageThumbnail").live("click", function(event) {
          jQuery("." + widget.widgetName + "-imageThumbnail").removeClass("" + widget.widgetName + "-imageThumbnailActive");
          jQuery(this).addClass("" + widget.widgetName + "-imageThumbnailActive");
          return jQuery("." + widget.widgetName + "-activeImage").attr("src", jQuery(this).attr("src"));
        });
        buttonset.buttonset();
      ...
      _openDialog: function() {
        ...
        jQuery("." + this.widgetName + "-activeImage").attr("src", jQuery("." + this.widgetName + "-imageThumbnailActive").first().attr("src"));
