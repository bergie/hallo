...
(function() {
  ...
  (function(jQuery) {
    return jQuery.widget("IKS.hallo", {
      ...
      isModified: function() {
        if (!this.previousContent) this.previousContent = this.originalContent;
      ...
      _deactivated: function(event) {
        if (event.data._keepActivated) return;
  ...
  (function(jQuery) {
    return jQuery.widget("IKS.halloformat", {
      ...
      populateToolbar: function(toolbar) {
        var addFormat, buttonset, enabled, format, widget, _ref,
          _this = this;
        widget = this;
        ...
        addFormat = function(format) {
          ...
          return _this.options.editable.element.keydown(function(e) {
            if (e.metaKey && _this.options.shortcuts[format] === e.which) {
              e.preventDefault();
              return _this.options.editable.execute(format);
            }
          });
        };
  ...
  (function(jQuery) {
    return jQuery.widget('IKS.halloimagecurrent', {
      ...
      _createTmpFeedback: function(image, position) {
        var el;
        if (position === 'middle') return this._createLineFeedbackElement();
      ...
      _handleDragEvent: function(event, ui) {
        ...
        if (position === this._lastPositionDrag) return;
  ...
  (function(jQuery) {
    return jQuery.widget('IKS.halloimagesearch', {
      ...
      _showResult: function(image) {
        var html,
          _this = this;
        if (!image.label) image.label = image.alt;
      ...
      _showNextPrev: function(results) {
        ...
        if (results.offset > 0) jQuery('.pager-prev', container).show();
  ...
  (function(jQuery) {
    return jQuery.widget('IKS.halloimagesuggestions', {
      ...
      _normalizeRelated: function(related) {
        if (_.isString(related)) return related;
        if (_.isArray(related)) return related.join(',');
        return related.pluck('@subject').join(',');
      },
      _prepareVIE: function() {
        if (!this.options.vie) this.options.vie = new VIE;
        if (this.options.vie.services.dbpedia) return;
        if (!this.options.dbPediaUrl) return;
      ...
      _getSuggestions: function() {
        ...
        this._prepareVIE();
        if (this.options.vie.services.dbpedia) this._getSuggestionsDbPedia(tags);
        ...
        return _.each(tags, function(tag) {
          return vie.load({
            ...
            return _.each(entities, function(entity) {
              ...
              if (!thumbnail) return;
              if (_.isObject(thumbnail)) img = thumbnail[0].value;
  ...
  (function(jQuery) {
    return jQuery.widget('IKS.halloimageupload', {
      ...
      _prepareIframe: function(widget) {
        ...
        if (iframe.length) return iframe;
    ...
    return jQuery.widget('IKS.halloindicator', {
      ...
      bindIndicator: function(indicator) {
        ...
        return this.options.editable.element.hover(function() {
          if (jQuery(this).hasClass('inEditMode')) return;
          return indicator.show();
        }, function(data) {
          if (jQuery(this).hasClass('inEditMode')) return;
          if (data.relatedTarget === indicator.get(0)) return;
          return indicator.hide();
        });
      },
  ...
  (function(jQuery) {
    return jQuery.widget('Hallo.halloToolbarFixed', {
      ...
      setPosition: function() {
        if (this.options.parentElement !== 'body') return;
        this.toolbar.css('position', 'absolute');
    ...
    jQuery.widget('IKS.hallobutton', {
      ...
      _create: function() {
        ...
        this.button.bind('mouseenter', function(event) {
          if (_this.isEnabled()) return _this.button.addClass(hoverclass);
        });
